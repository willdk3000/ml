...
r1 as (
SELECT 
distinct(route_pair) as route_pair,
avg(planned_layover_sec) as avg_layover_sec
FROM r
group by route_pair
)
SELECT 
0 as on_time_a,
1900 as planned_dur_b,
0.971985 as p85_pct_b,
241.93 as range7525_b,
--300 as planned_layover_sec,
avg_layover_sec as planned_layover_sec,
0 as ampeak_a,
1 as pmpeak_a,
route_pair
from r1
