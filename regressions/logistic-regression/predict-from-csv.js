...
const INPUT_CSV = './inference-data/predict-var-p85-pm-latea_oct-nov2025.csv';         // CSV containing rows to predict
...
const NUMERIC_COLUMNS = ['on_time_a', 'planned_layover_sec', 'p85_pct_b', 'range7525_b', 'planned_dur_b', 'ampeak_a', 'pmpeak_a']; // numeric features
